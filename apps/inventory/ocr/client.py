...
ANNOTATION_PROMPT = (
    ...
    'Tabulka zboží může mít mezi položkami řádky, které samy zbožím nejsou: '
    'nadpisy kategorií (celý řádek velkými písmeny bez kódu a ceny, např. '
    '„MLÉČNÉ VÝROBKY", „KONZERVOVANÉ POTRAVINY") a pod názvem položky '
    'drobný řádek s čárovým kódem (GTIN/EAN) – ten není ani samostatná '
    'položka, ani součást názvu, prostě ho přeskoč. '
    'Když doklad u množství rozlišuje počet balení a kolik je v jednom '
    'balení (např. sloupce „Dodáno/Objednáno" a „Balení" s hodnotou jako '
    '„24 balení" nebo „Balení po 300"), vyplň `mnozstvi` počtem balení '
    'a `pocet_v_baleni` tím číslem z balení – nenásob je sám, přepočet na '
    'sklad dělá systém. `cena_za_mj` v tomhle případě zůstává cena za jeden '
    'kus/kg, ne za celé balení. '
    'Řádky se slevou vázanou na předchozí položku (např. „Množstevní sleva '
