...
(function() {
    ...
    function createMealCard(meal, dayIndex, mealIndex) {
        ...
        // Najdeme název receptu podle kódu
        const recipe = recipeChoices.find(r => r.id === meal.recipe_code);
        const recipeName = recipe ? recipe.text : meal.recipe_code;
            ...
            <div class="d-flex justify-content-between align-items-start">
                <div class="flex-grow-1">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div>
                            <strong class="recipe-name">${escapeHtml(recipeName)}</strong>
                            <div class="text-muted small">${escapeHtml(meal.recipe_code)}</div>
                        </div>
                    </div>
                    ${meal.note ? `
    ...
    function submitAddMeal(dayIndex) {
        ...
        addMealAjax(dayIndex, recipeCode, mealType, note, null);
